...
\begin{figure*}[h]
  ...
  \Description{The temporal evolution of 8 accounts among the 90 spreading misinformation. For most of the accounts, we see a drop on June 9, 2020. We also see some reduced reach periods lasting a few weeks or months for some accounts.}
  \label{figure_3}
\end{figure*}
...
\begin{figure}[h]
  ...
  \Description{We see more reactions, shares and comments per post during the `free' periods compared with the `repeat offender' periods).}
  \label{figure_4}
\end{figure}
